...
:::info Just checking
1. You got your ACP account? Register via <ILabURL>iLab</ILabURL>. Of course, you will need your Monash iLab credentials to do that, should be quick enough to register.
