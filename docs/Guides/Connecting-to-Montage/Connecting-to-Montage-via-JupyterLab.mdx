---
title: Connecting to Montage via JupyterLab
sidebar_position: 2
---
...
1. Open your favourite internet browser. Go to:
    ...
    ```
1. You are now in!
    <img src={require('@site/static/img/Guides/Connecting-to-Montage/Connecting-to-Montage-via-JupyterLab_1.png').default}
