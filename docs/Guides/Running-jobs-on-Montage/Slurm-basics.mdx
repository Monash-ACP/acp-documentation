...
Misuse of shared resources impacts the experience of all users — you have been warned.
:::
...
These SLURM directives are used to guide SLURM in allocating resources and scheduling your job efficiently. For detailed examples on how to write these scripts, see the [Batch Jobs](./Batch-jobs.mdx) guide.

If you need to run tasks interactively for testing or debugging, see the [Interactive Jobs](./Interactive-jobs.mdx) guide.

> **How many cores/RAM do we have?**  
> Check the [Resources in Slurm](./Specifying-resources-in-Slurm.mdx) guide for cluster limits and hardware specs.
