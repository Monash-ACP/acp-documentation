...
- **Partition/queue**: Which group of nodes your job should run on, often determined by job size, time limits, or user permissions. Read on our [QOS](./Cluster-Nodes-and-Partitions.mdx).
...
> Check the [Resources in Slurm](./Cluster-Nodes-and-Partitions.mdx) guide for cluster limits and hardware specs.
