...
1. SLURM places your job in its queue. It will quickly identify available resources to allocate for your job.
1. Your job will eventually run on the allocated resources on the compute nodes.

There is still a lot to learn about how to run jobs on MONTAGE! Dive into [Running jobs on Montage](../Running-jobs-on-Montage/Batch-jobs.mdx) to learn more.
